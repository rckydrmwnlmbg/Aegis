 ...
 * [x] **Task 1:** Inisialisasi proyek Laravel 11. Konfigurasi PostgreSQL.
 ...
 * [x] **Task 4:** Buat Feature Test (PHPUnit/Pest) untuk memastikan Login gagal jika kredensial salah. (*Rujuk @testing-strategy.md*).
