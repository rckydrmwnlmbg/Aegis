 ...
 * [ ] **Task 1 (Backend):** Buat endpoint POST /api/v1/sync/incidents dan hazards. Pastikan mengembalikan status 202 Accepted HANYA setelah file tersimpan lokal dan Job masuk ke Queue.
 ...
 * [ ] **Task 3:** Simpan *Raw Payload* dari LLM ke tabel ai_runs, lalu ekstrak dan pindahkan ke tabel incidents atau hazard_observations dengan status draft_ready.
